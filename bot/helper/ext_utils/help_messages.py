...
Example: <code>{escape("<b>By:</b> <a href='https://t.me/huntermirleech'>Gabriel</a>")}</code>
Result: <b>By:</b> <a href='https://t.me/huntermirleech'>Gabriel</a>\n
...
Send metadata title for video file like <b>Uploaded by @huntermirleech</b>
<b>Current:</b> <code>{}</code>\n
<i>Timeout: 60s.</i>
'''
