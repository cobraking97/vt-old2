...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 30,
                  ...
                  'CHANNEL_USERNAME': 'https://t.me/huntermirleech',
                  'AUTHOR_NAME': 'Gabriel',
                  'AUTHOR_URL': 'https://t.me/huntermirleech',
                  'DRIVE_SEARCH_TITLE': 'Drive Search',
                  'GD_INFO': 'By @huntermirleech',
                  ...
                  'COMPRESS_BANNER': 'Re-Endoced by @huntermirleech',
                  'LIB264_PRESET': 'superfast',
                  'LIB265_PRESET': 'faster',
                  'HARDSUB_FONT_NAME': 'huntermirleech',
                  ...
                  'IMAGE_CANCEL': 'https://telegra.ph/file/5469a2d03f6b1b8b88dab.jpg',
                  ...
                  'IMAGE_MEDINFO': 'https://telegra.ph/file/5469a2d03f6b1b8b88dab.jpg',
                  ...
                  'IMAGE_USETIINGS': 'https://telegra.ph/file/5469a2d03f6b1b8b88dab.jpg',
...
async def load_config():
    ...
    HARDSUB_FONT_NAME = environ.get('HARDSUB_FONT_NAME', 'Mirror Hunter')
    ...
    FSUB_CHANNEL_ID = int(environ.get('FSUB_CHANNEL_ID', -1002433096058))
    ...
    IMAGE_ARIA = environ.get('IMAGE_ARIA', 'https://envs.sh/fC3.jpg')
    IMAGE_AUTH = environ.get('IMAGE_AUTH', 'https://envs.sh/fC3.jpg')
    IMAGE_BOLD = environ.get('IMAGE_BOLD', 'https://envs.sh/fC3.jpg')
    IMAGE_BYE = environ.get('IMAGE_BYE', 'https://envs.sh/fC3.jpg')
    IMAGE_CANCEL = environ.get('IMAGE_CANCEL', 'https://envs.sh/fC3.jpg')
    IMAGE_CAPTION = environ.get('IMAGE_CAPTION', 'https://envs.sh/fC3.jpg')
    IMAGE_COMMONS_CHECK = environ.get('IMAGE_COMMONS_CHECK', 'https://envs.sh/fC3.jpg')
    IMAGE_COMPLETE = environ.get('IMAGE_COMPLETE', images)
    IMAGE_CONEDIT = environ.get('IMAGE_CONEDIT', 'https://envs.sh/fC3.jpg')
    IMAGE_CONPRIVATE = environ.get('IMAGE_CONPRIVATE', 'https://envs.sh/fC3.jpg')
    IMAGE_CONSET = environ.get('IMAGE_CONSET', 'https://envs.sh/fC3.jpg')
    IMAGE_CONVIEW = environ.get('IMAGE_CONVIEW', 'https://envs.sh/fC3.jpg')
    IMAGE_DUMP = environ.get('IMAGE_DUMP', 'https://envs.sh/fC3.jpg')
    IMAGE_EXTENSION = environ.get('IMAGE_EXTENSION', 'https://envs.sh/fC3.jpg')
    IMAGE_GD = environ.get('IMAGE_GD', 'https://envs.sh/fC3.jpg')
    IMAGE_HELP = environ.get('IMAGE_HELP', 'https://envs.sh/fC3.jpg')
    IMAGE_HTML = environ.get('IMAGE_HTML', 'https://envs.sh/fC3.jpg')
    IMAGE_IMDB = environ.get('IMAGE_IMDB', 'https://envs.sh/fC3.jpg')
    IMAGE_INFO = environ.get('IMAGE_INFO', 'https://envs.sh/fC3.jpg')
    IMAGE_ITALIC = environ.get('IMAGE_ITALIC', 'https://envs.sh/fC3.jpg')
    IMAGE_JD = environ.get('IMAGE_JD', 'https://envs.sh/fC3.jpg')
    IMAGE_LOGS = environ.get('IMAGE_LOGS', 'https://envs.sh/fC3.jpg')
    IMAGE_MDL = environ.get('IMAGE_MDL', 'https://envs.sh/fC3.jpg')
    IMAGE_MEDINFO = environ.get('IMAGE_MEDINFO', 'https://envs.sh/fC3.jpg')
    IMAGE_METADATA = environ.get('IMAGE_METADATA', 'https://envs.sh/fC3.jpg')
    IMAGE_MONO = environ.get('IMAGE_MONO', 'https://envs.sh/fC3.jpg')
    IMAGE_NORMAL = environ.get('IMAGE_NORMAL', 'https://envs.sh/fC3.jpg')
    IMAGE_OWNER = environ.get('IMAGE_OWNER', 'https://envs.sh/fC3.jpg')
    IMAGE_PAUSE = environ.get('IMAGE_PAUSE', 'https://envs.sh/fC3.jpg')
    IMAGE_PRENAME = environ.get('IMAGE_PRENAME', 'https://envs.sh/fC3.jpg')
    IMAGE_QBIT = environ.get('IMAGE_QBIT', 'https://envs.sh/fC3.jpg')
    IMAGE_RCLONE = environ.get('IMAGE_RCLONE', 'https://envs.sh/fC3.jpg')
    IMAGE_REMNAME = environ.get('IMAGE_REMNAME', 'https://envs.sh/fC3.jpg')
    IMAGE_RSS = environ.get('IMAGE_RSS', 'https://envs.sh/fC3.jpg')
    IMAGE_SEARCH = environ.get('IMAGE_SEARCH', 'https://envs.sh/fC3.jpg')
    IMAGE_STATS = environ.get('IMAGE_STATS', 'https://envs.sh/fC3.jpg')
    IMAGE_STATUS = environ.get('IMAGE_STATUS', 'https://envs.sh/fC3.jpg')
    IMAGE_SUFNAME = environ.get('IMAGE_SUFNAME', 'https://envs.sh/fC3.jpg')
    IMAGE_TMDB = environ.get('IMAGE_TMDB', 'https://envs.sh/fC3.jpg')
    IMAGE_TXT = environ.get('IMAGE_TXT', 'https://envs.sh/fC3.jpg')
    IMAGE_UNAUTH = environ.get('IMAGE_UNAUTH', 'https://envs.sh/fC3.jpg')
    IMAGE_UNKNOW = environ.get('IMAGE_UNKNOW', 'https://envs.sh/fC3.jpg')
    IMAGE_USER = environ.get('IMAGE_USER', 'https://envs.sh/fC3.jpg')
    IMAGE_USETIINGS = environ.get('IMAGE_USETIINGS', 'https://envs.sh/fC3.jpg')
    IMAGE_VIDTOOLS = environ.get('IMAGE_VIDTOOLS', 'https://envs.sh/fC3.jpg')
    IMAGE_WEL = environ.get('IMAGE_WEL', 'https://envs.sh/fC3.jpg')
    IMAGE_WIBU = environ.get('IMAGE_WIBU', 'https://envs.sh/fC3.jpg')
    IMAGE_YT = environ.get('IMAGE_YT', 'https://envs.sh/fC3.jpg')
    IMAGE_ZIP = environ.get('IMAGE_ZIP', 'https://envs.sh/fC3.jpg')
    # ======================================================================
